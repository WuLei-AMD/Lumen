...
DOCKER_ENV=(
    ...
    -e DSV4_DUMP_LAYER_ACT="${DSV4_DUMP_LAYER_ACT:-0}"
    -e DSV4_DUMP_DIR="${DSV4_DUMP_DIR:-/root/models/dsv4_layer_act_lumen}"
    -e DSV4_DUMP_TAG="${DSV4_DUMP_TAG:-lumen}"
    -e DSV4_DUMP_LAYER_ACT_MAX="${DSV4_DUMP_LAYER_ACT_MAX:-1}"
    -e DSV4_DUMP_LAYER1_INNER="${DSV4_DUMP_LAYER1_INNER:-1}"
    -e DSV4_DUMP_STOP_AFTER_LAYER="${DSV4_DUMP_STOP_AFTER_LAYER:-}"
    -e DSV4_DUMP_GRAD_NORM="${DSV4_DUMP_GRAD_NORM:-0}"
    -e DSV4_DUMP_GRAD_NORM_DIR="${DSV4_DUMP_GRAD_NORM_DIR:-/root/models/dsv4_gn_dump_lumen}"
    -e DSV4_DUMP_ATTN_IO="${DSV4_DUMP_ATTN_IO:-0}"
    -e DSV4_DUMP_ATTN_IO_DIR="${DSV4_DUMP_ATTN_IO_DIR:-/root/models/dsv4_attn_io_lumen}"
    -e DSV4_DUMP_MHC_DX="${DSV4_DUMP_MHC_DX:-0}"
    -e DSV4_DUMP_MHC_DX_DIR="${DSV4_DUMP_MHC_DX_DIR:-/root/models/dsv4_mhc_dx_lumen}"
    ...
    -e LUMEN_DSV4_LOCAL_RMSNORM="${LUMEN_DSV4_LOCAL_RMSNORM:-0}"
    -e LUMEN_DSV4_DUP_TORCH_LINEAR="${LUMEN_DSV4_DUP_TORCH_LINEAR:-0}"
