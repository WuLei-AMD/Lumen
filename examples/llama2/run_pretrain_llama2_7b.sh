#!/bin/bash
###############################################################################
# Lumen — Llama2-7B pretrain (BF16 or FP8 delayed/hybrid)
#
# Usage:
#   PRECISION=bf16 bash run_pretrain_llama2_7b.sh
...
# Repo root = two levels up from examples/llama2/
...
CONTAINER_NAME="${CONTAINER_NAME:-lumen_llama2_7b_${PRECISION}}"
...
# Shared Megatron pretrain driver lives under examples/llama31/.
...
echo ""
echo "[DONE] log: ${RESULTS_DIR}/lumen_llama2_7b_${PRECISION}.log"
